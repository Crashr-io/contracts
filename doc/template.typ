...
#let listing_transaction = transaction(
  "List",
  inputs: (
    (
      name: "Seller Wallet",
  ...
  outputs: (
    (
      name: "Listing UTXO",
      address: "Marketplace Smart Contract",
      value: (
        ada: "2",
        NFT_1: "1",
        NFT_2: "1",
...
#let buying_transaction = transaction(
  "Buy",
  inputs: (
    (
      name: "Buyer Wallet",
  ...
  outputs: (
    (
      name: "Marketplace Fee Output",
      address: "Marketplace Fee Address",
      value: (
        ada: "2",
      ),
      datum: (
        blake2b256: "spend_tx_out_ref"
      )
    ),
    (
      name: "Seller Output",
...
#let cancel_transaction = transaction(
  "Cancel",
  inputs: (
    (
      name: "Listing UTXO",
